...
export const invitationService = {
  createInvitationCode: (): Promise<InvitationCode> => invitationRepository.createInvitationCode(),
  updateInvitationCode: (data: InvitationUpdateForm[]): Promise<InvitationCode[]> =>
