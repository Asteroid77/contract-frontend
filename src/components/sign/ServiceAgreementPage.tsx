...
import type { ServiceAgreementPageVo } from '@/components/sign/api/sign'
...
import { TreeLookup } from '../widget/_utils/TreeLookup'
import { ServiceAgreementStatusOption } from './constant/enum'
import { SelectLookup } from '../widget/_utils/SelectLookup'
