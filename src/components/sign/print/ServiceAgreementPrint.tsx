...
// --- 工具类 ---
import { TreeLookup } from '@/components/widget/_utils/TreeLookup'
import { SelectLookup } from '@/components/widget/_utils/SelectLookup'
import PcaData from '@/components/widget/constant/PCA.json'
...
// --- 引入通用 Diff 组件 (上一轮定义的) ---
import { DiffRenderer } from '@/components/approval/print/DiffRenderer'
import clsx from 'clsx'
import { compareList, type DiffRow } from '@/components/approval/print/utils/ListDiff'
