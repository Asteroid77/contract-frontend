import type { ServiceAgreementUIMap, ServiceAgreementVo } from '@/components/sign/api/sign'
...
import { createServiceAgreementModel } from './model'
import { WarningOutlined } from '@vicons/antd'
import type { ValidateError } from '@/types/vendor/naive-ui'
import { createServiceAgreementRules } from './rules'
import FormSkeleton from '../widget/FormSkeleton'
