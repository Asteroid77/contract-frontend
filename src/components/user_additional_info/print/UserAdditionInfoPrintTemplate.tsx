...
import {
  RegisterType,
  RegisterTypeOption,
} from '@/components/user_additional_info/constant/RegisterTypeEnum'
import { BankOption } from '@/components/widget/constant/BankConstant'
import areaData from '@/components/widget/constant/PCA.json'
import { match } from 'ts-pattern'
import { findPathInTree } from '@/components/approval/utils'
