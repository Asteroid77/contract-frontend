const i18NInfo = {
  ...
  auth: {
    ...
    twoFactor: {
      ...
      rememberMe: 'Keep me signed in (long session)',
  ...
  domain: {
    ...
    workOrder: {
      ...
      action: {
        ...
        score: 'Rate',
        reply: 'Reply',
        updateScore: 'Update Rating',
      },
      message: {
        createSuccess: 'Work order created',
        cancelConfirm: 'Cancel this work order?',
        cancelSuccess: 'Work order cancelled',
        completeConfirm: 'Mark this work order as complete?',
        completeSuccess: 'Work order completed',
        reopenConfirm: 'Reopen this work order?',
        reopenSuccess: 'Work order reopened',
        claimConfirm: 'Claim this work order?',
        claimSuccess: 'Work order claimed',
        releaseConfirm: 'Release this work order?',
        releaseSuccess: 'Work order released',
        rejectConfirm: 'Reject the current handler? They will be blacklisted.',
        rejectSuccess: 'Handler rejected',
        replySuccess: 'Reply sent',
        scoreSuccess: 'Rating submitted',
        removeBlacklistConfirm: 'Remove this handler from blacklist?',
        removeBlacklistSuccess: 'Blacklist removed',
        noReplies: 'No replies yet',
      },
      label: {
        userReply: 'User',
        handlerReply: 'Handler',
