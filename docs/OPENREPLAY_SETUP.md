...
# 2. 确认 Ingest 端点（通常不需要改）
VITE_OPENREPLAY_INGEST_POINT = http://localhost:9001/ingest
...
# 3. 启用开关
VITE_OPENREPLAY_ENABLED = true  # 生产环境启用
```
...
VITE_OPENREPLAY_PROJECT_KEY = abc123def456ghi789
VITE_OPENREPLAY_INGEST_POINT = https://openreplay.yourdomain.com/ingest
```
