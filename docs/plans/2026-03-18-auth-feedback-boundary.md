...
- Run: `rg -n "403.*Query|401.*Query|鉴权提示|auth feedback|useRequestPlugin" docs/request-auth-refresh-architecture.md docs/plans/2026-03-18-auth-feedback-boundary-design.md`
...
- Run: `rg -n "^# |^## " docs/request-auth-refresh-architecture.md docs/plans/2026-03-18-auth-feedback-boundary-design.md`
